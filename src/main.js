...
if (process.platform != "darwin") require("update-electron-app")({ repo: "fakepassing/snowycp" });

const ALLOWED_ORIGINS = [
  "https://snowycp.com",
  "https://play.snowycp.com",
];
...
const createWindow = () => {
  ...
  new Promise((resolve) =>
    setTimeout(() => {
      mainWindow.loadURL("https://play.snowycp.com");
      resolve();
    }, 5000)
  );
};
...
const launchMain = () => {
  ...
  app.setAsDefaultProtocolClient("snowycp");
